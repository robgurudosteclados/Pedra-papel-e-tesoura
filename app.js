...
const MATCH_TRACKS = [
  ...
  { // Track 3 — alt-rock sincopado: F# menor / A maior, baixo fora do tempo forte, guitarra alternando stab/chug
    name:'Rota Noturna', octave:3, subdivisions:8, swing:0,
    progression:[{root:'F#',type:'min'},{root:'D',type:'maj'},{root:'A',type:'maj'},{root:'E',type:'maj'}],
    kickSteps:[0,3,6], snareSteps:[3,7], hihatSteps:[1,3,5,7],
    bassPattern:[{step:0,len:1,deg:0},{step:3,len:1,deg:0},{step:4,len:2,deg:2},{step:6,len:2,deg:1}],
    bassWave:'triangle', bassFilter:550,
    guitarPattern:[{step:0,len:1.2,type:'stab'},{step:2,len:0.4,type:'chug'},{step:5,len:1.2,type:'stab'}],
    guitarWave:['sawtooth','sawtooth'], guitarDetune:0.008,
    padVoicing:'open',
    riff:[{n:'F#',o:4},{n:'A',o:4},{n:'D',o:5},{n:'C#',o:5}], riffPlacement:'both', riffWave:'triangle' },
];
